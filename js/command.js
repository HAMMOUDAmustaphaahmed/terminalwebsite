var portfolio = "https://hammoudamustaphaahmed.github.io/MyResume.github.io/"
var linkedin = "https://www.linkedin.com/in/hammouda-ahmed-a55270195/"
var github = "https://github.com/HAMMOUDAmustaphaahmed"
var blockchain = "https://hammoudamustaphaahmed.pythonanywhere.com/"
...
whois = [
    "<br>",
    "Welcome to my Terminal Website, I'm <span class=\"command\">Hammouda Ahmed Mustapha</span>!😎",
    "<br>",
    "<br>",
    "- As a <span class=\"command\">highly motivated</span> and <span class=\"command\">disciplined</span> computer engineer, I am deeply committed to pursuing a career in full stack development.",
    "<br>",
...
projects = [
    ...
    '<a href="' + kryptify + '" target="_blank">Kryptify' + "</a>",
...
social = [
    "<br>",
    '<span class=\"command\">LinkedIn</span>       <a href="' + linkedin + '" target="_blank">LinkedIn/' + "</a>",
    '<span class=\"command\">GitHub</span>         <a href="' + github + '" target="_blank">GitHub/' + "</a>",
    "<br>"
]
...
banner = [
  ...
  '                                                                                     ',
  '.-----------------------------------------------------------------------------.                                      ue$$$$$$$$$e.',
  '||Es| |F1 |F2 |F3 |F4 |F5 | |F6 |F7 |F8 |F9 |F10|                  HAMMOUDA_   |                                   o$$$P""     "#$$$b',
...
suggestion = [
  "<p class>",
  "<span class=\"color2\">Welcome to my terminal website! This website was inspired by <a target=\"_blank\" href=\>ForrestKnight~</a><br>For a list of available commands, type <span class=\"command\">help</span> .",
  "</span>",
  "</p>",
]
